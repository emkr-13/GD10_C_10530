...
import com.example.gd10_c_10530.databinding.ActivityFormAddMahasiswaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTgl.setOnClickListener {
            val datePicker = DatePickerDialog.OnDateSetListener{
                ...
                binding.tglView.text = year.toString() + "-" + String.format("%02d", month) + "-" + String.format("%02d", dayofMonth)
            }
